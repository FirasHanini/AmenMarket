                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        <div className="space-y-3">
                            ...
                            <h3 className="text-xl font-semibold">Vendeurs Vérifiés</h3>
                            <p className="text-muted-foreground">Partenaires rigoureusement sélectionnés</p>
                        </div>
                        <div className="space-y-3">
                            <div
                                className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
                            ...
                            <p className="text-muted-foreground">Comparez et économisez</p>
                        </div>
                        <div className="space-y-3">
                            <div
                                className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
                            ...
                            <h3 className="text-xl font-semibold">Livraison Partout</h3>
                            <p className="text-muted-foreground">Expédition rapide en Tunisie.</p>
                        </div>
                    </div>
                </div>
            </section>
