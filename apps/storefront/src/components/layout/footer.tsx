...
async function Copyright() {
    ...
    return (
        <div>
            © {new Date().getFullYear()} Boutique Amen. Tous droits réservés.
        </div>
    )
}
        ...
        <footer className="border-t border-border mt-auto">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        <h4 className="text-sm font-semibold mb-4">Amen Bank</h4>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li>
                                <a
                                    href="https://www.amenbank.com.tn/fr/notre-identite.html"
                                    target="_blank"
                            ...
                            <li>
                                <a
                                    href="https://www.amenbank.com.tn/fr/identite-groupe.html"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-foreground transition-colors"
                                >
                             ...
                             <li>
                                <a
                                    href="https://www.amenbank.com.tn/fr/actionnaires.html"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-foreground transition-colors"
                                >
                            ...
                            <li>
                                <a
                                    href="https://www.amenbank.com.tn/fr/amen-tv.html"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-foreground transition-colors"
                                >
